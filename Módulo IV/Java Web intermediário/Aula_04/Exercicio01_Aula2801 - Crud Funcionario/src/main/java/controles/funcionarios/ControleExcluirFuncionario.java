...
/**
 * Servlet implementation class ControleExcluirFuncionario
 */
@WebServlet("/funcionario.exclusao")
public class ControleExcluirFuncionario extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControleExcluirFuncionario() {
        super();

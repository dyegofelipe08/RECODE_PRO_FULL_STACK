...
/**
 * Servlet implementation class ControleContultaPreEdicao
 */
@WebServlet("/controle.consulta.pre.edicao")
public class ControleContultaPreEdicao extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControleContultaPreEdicao() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			despacho = request.getRequestDispatcher("saidaEditar.jsp");
